...
#SBATCH --mem=2048M
#SBATCH --array=1-19
#SBATCH --output=/home/asharif/scratch/StreamX_optimizer/outputs/2025_11_01__14_05_18__test0/1_0/output_%j.txt
...
$(sed -n "${SLURM_ARRAY_TASK_ID}p" < /home/asharif/scratch/StreamX_optimizer/outputs/2025_11_01__14_05_18__test0/export_1_0.dat)
