...
#SBATCH --mem=2048M
#SBATCH --array=1-290
#SBATCH --output=/home/asharif/StreamX_optimizer/results/outputs/2025_10_22__00_20_14__test0/1_0/output_%j.txt
...
$(sed -n "${SLURM_ARRAY_TASK_ID}p" < /home/asharif/StreamX_optimizer/results/outputs/2025_10_22__00_20_14__test0/export_1_0.dat)
