...
#SBATCH --mem=4096M
#SBATCH --array=1-300
#SBATCH --output=/home/asharif/scratch/StreamX_optimizer/outputs/2025_11_06__21_18_21__test0/1_0/output_%j.txt
...
$(sed -n "${SLURM_ARRAY_TASK_ID}p" < /home/asharif/scratch/StreamX_optimizer/outputs/2025_11_06__21_18_21__test0/export_1_0.dat)
