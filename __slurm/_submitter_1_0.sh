...
#SBATCH --mem=2048M
#SBATCH --array=1-600
#SBATCH --output=/home/asharif/scratch/StreamX_optimizer/outputs/2025_10_23__21_23_52__test0/1_0/output_%j.txt
...
$(sed -n "${SLURM_ARRAY_TASK_ID}p" < /home/asharif/scratch/StreamX_optimizer/outputs/2025_10_23__21_23_52__test0/export_1_0.dat)
