...
#SBATCH --mem=2048M
#SBATCH --array=1-240
#SBATCH --output=/home/asharif/scratch/StreamX_optimizer/outputs/2026_02_17__15_53_18___/0_0/output_%j.txt
...
$(sed -n "${SLURM_ARRAY_TASK_ID}p" < /home/asharif/scratch/StreamX_optimizer/outputs/2026_02_17__15_53_18___/export_0_0.dat)
