...
#SBATCH --mem=4096M
#SBATCH --array=1-1
#SBATCH --output=/home/asharif/StreamX_optimizer/results/outputs/2025_10_17__21_03_42__test0/0_0/output_%j.txt
#SBATCH --constraint=granite

source ~/venv_streamx/bin/activate
module load python/3.10

$(sed -n "${SLURM_ARRAY_TASK_ID}p" < /home/asharif/StreamX_optimizer/results/outputs/2025_10_17__21_03_42__test0/export_0_0.dat)
