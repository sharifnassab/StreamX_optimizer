...
#SBATCH --mem=2048M
#SBATCH --array=1-300
#SBATCH --output=/home/asharif/scratch/StreamX_optimizer/outputs/2025_10_23__20_45_51__test0/0_0/output_%j.txt
...
$(sed -n "${SLURM_ARRAY_TASK_ID}p" < /home/asharif/scratch/StreamX_optimizer/outputs/2025_10_23__20_45_51__test0/export_0_0.dat)
