...
#SBATCH --mem=2048M
#SBATCH --array=1-580
#SBATCH --output=/home/asharif/StreamX_optimizer/results/outputs/2025_10_22__00_20_14__test0/0_0/output_%j.txt
...
$(sed -n "${SLURM_ARRAY_TASK_ID}p" < /home/asharif/StreamX_optimizer/results/outputs/2025_10_22__00_20_14__test0/export_0_0.dat)
