...
#SBATCH --mem=4096M
#SBATCH --array=1-15
#SBATCH --output=/home/asharif/scratch/StreamX_optimizer/outputs/2025_11_15__12_15_03__test0/0_0/output_%j.txt
...
$(sed -n "${SLURM_ARRAY_TASK_ID}p" < /home/asharif/scratch/StreamX_optimizer/outputs/2025_11_15__12_15_03__test0/export_0_0.dat)
