...
#SBATCH --mem=4096M
#SBATCH --array=1-1
#SBATCH --output=/home/asharif/StreamX_optimizer/results/outputs/2025_10_20__14_48_26__test0/0_0/output_%j.txt
...
$(sed -n "${SLURM_ARRAY_TASK_ID}p" < /home/asharif/StreamX_optimizer/results/outputs/2025_10_20__14_48_26__test0/export_0_0.dat)
