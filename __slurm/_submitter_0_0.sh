...
#SBATCH --mem=2048M
#SBATCH --array=1-20
#SBATCH --output=/home/asharif/StreamX_optimizer/results/outputs/2025_10_22__00_00_54__test0/0_0/output_%j.txt
