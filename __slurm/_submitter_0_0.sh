...
#SBATCH --mem=4096M
#SBATCH --array=1-5
#SBATCH --output=/home/asharif/scratch/StreamX_optimizer/outputs/2025_11_13__22_41_26__test0/0_0/output_%j.txt
...
$(sed -n "${SLURM_ARRAY_TASK_ID}p" < /home/asharif/scratch/StreamX_optimizer/outputs/2025_11_13__22_41_26__test0/export_0_0.dat)
