...
#SBATCH --mem=4096M
#SBATCH --array=1-1
#SBATCH --output=/home/asharif/scratch/StreamX_optimizer/outputs/2026_03_28__06_25_38__test0/0_0/output_%j.txt
...
$(sed -n "${SLURM_ARRAY_TASK_ID}p" < /home/asharif/scratch/StreamX_optimizer/outputs/2026_03_28__06_25_38__test0/export_0_0.dat)
