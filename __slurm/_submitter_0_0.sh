...
#SBATCH --mem=2048M
#SBATCH --array=1-2
#SBATCH --output=/home/asharif/scratch/StreamX_optimizer/outputs/2026_02_17__12_10_58___/0_0/output_%j.txt
...
$(sed -n "${SLURM_ARRAY_TASK_ID}p" < /home/asharif/scratch/StreamX_optimizer/outputs/2026_02_17__12_10_58___/export_0_0.dat)
