...
#SBATCH --mem=2048M
#SBATCH --array=1-900
#SBATCH --output=/home/asharif/scratch/StreamX_optimizer/outputs/2025_11_15__12_02_57__test0/4_0/output_%j.txt
...
$(sed -n "${SLURM_ARRAY_TASK_ID}p" < /home/asharif/scratch/StreamX_optimizer/outputs/2025_11_15__12_02_57__test0/export_4_0.dat)
