...
#SBATCH --mem=10240M
#SBATCH --array=1-10
#SBATCH --output=/home/asharif/scratch/StreamX_optimizer/outputs/2025_11_18__15_54_00__test0/4_0/output_%j.txt
...
$(sed -n "${SLURM_ARRAY_TASK_ID}p" < /home/asharif/scratch/StreamX_optimizer/outputs/2025_11_18__15_54_00__test0/export_4_0.dat)
