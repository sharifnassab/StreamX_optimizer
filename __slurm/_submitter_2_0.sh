...
#SBATCH --mem=2048M
#SBATCH --array=1-150
#SBATCH --output=/home/asharif/scratch/StreamX_optimizer/outputs/2025_11_16__23_41_21__test0/2_0/output_%j.txt
...
$(sed -n "${SLURM_ARRAY_TASK_ID}p" < /home/asharif/scratch/StreamX_optimizer/outputs/2025_11_16__23_41_21__test0/export_2_0.dat)
