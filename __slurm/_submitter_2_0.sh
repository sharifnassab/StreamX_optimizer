...
#SBATCH --mem=2048M
#SBATCH --array=1-1
#SBATCH --output=/home/asharif/scratch/StreamX_optimizer/outputs/2026_04_03__01_18_52__test0/2_0/output_%j.txt
...
$(sed -n "${SLURM_ARRAY_TASK_ID}p" < /home/asharif/scratch/StreamX_optimizer/outputs/2026_04_03__01_18_52__test0/export_2_0.dat)
