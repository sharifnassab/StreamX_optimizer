...
#SBATCH --mem=2048M
#SBATCH --array=1-240
#SBATCH --output=/home/asharif/scratch/StreamX_optimizer/outputs/2026_03_20__23_42_48___/2_0/output_%j.txt
...
$(sed -n "${SLURM_ARRAY_TASK_ID}p" < /home/asharif/scratch/StreamX_optimizer/outputs/2026_03_20__23_42_48___/export_2_0.dat)
