...
#SBATCH --mem=2048M
#SBATCH --array=1-6
#SBATCH --output=/home/asharif/scratch/StreamX_optimizer/outputs/2026_02_12__19_17_49__test0/5_0/output_%j.txt
...
$(sed -n "${SLURM_ARRAY_TASK_ID}p" < /home/asharif/scratch/StreamX_optimizer/outputs/2026_02_12__19_17_49__test0/export_5_0.dat)
