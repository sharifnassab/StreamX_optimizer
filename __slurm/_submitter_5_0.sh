...
#SBATCH --mem=4096M
#SBATCH --array=1-5
#SBATCH --output=/home/asharif/scratch/StreamX_optimizer/outputs/2025_11_16__06_20_51__test0/5_0/output_%j.txt
...
$(sed -n "${SLURM_ARRAY_TASK_ID}p" < /home/asharif/scratch/StreamX_optimizer/outputs/2025_11_16__06_20_51__test0/export_5_0.dat)
