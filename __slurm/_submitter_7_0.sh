...
#SBATCH --mem=4096M
#SBATCH --array=1-15
#SBATCH --output=/home/asharif/scratch/StreamX_optimizer/outputs/2025_11_16__06_20_51__test0/7_0/output_%j.txt
...
$(sed -n "${SLURM_ARRAY_TASK_ID}p" < /home/asharif/scratch/StreamX_optimizer/outputs/2025_11_16__06_20_51__test0/export_7_0.dat)
