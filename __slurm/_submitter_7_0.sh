...
#SBATCH --mem=2048M
#SBATCH --array=1-120
#SBATCH --output=/home/asharif/scratch/StreamX_optimizer/outputs/2026_02_21__11_38_22___/7_0/output_%j.txt
...
$(sed -n "${SLURM_ARRAY_TASK_ID}p" < /home/asharif/scratch/StreamX_optimizer/outputs/2026_02_21__11_38_22___/export_7_0.dat)
