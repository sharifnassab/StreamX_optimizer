...
#SBATCH --mem=2048M
#SBATCH --array=1-20
#SBATCH --output=/home/asharif/scratch/StreamX_optimizer/outputs/2026_04_03__01_18_25__test0/7_0/output_%j.txt
...
$(sed -n "${SLURM_ARRAY_TASK_ID}p" < /home/asharif/scratch/StreamX_optimizer/outputs/2026_04_03__01_18_25__test0/export_7_0.dat)
