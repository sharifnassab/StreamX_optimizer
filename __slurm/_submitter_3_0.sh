...
#SBATCH --mem=2048M
#SBATCH --array=1-180
#SBATCH --output=/home/asharif/scratch/StreamX_optimizer/outputs/2026_02_12__20_36_28___/3_0/output_%j.txt
...
$(sed -n "${SLURM_ARRAY_TASK_ID}p" < /home/asharif/scratch/StreamX_optimizer/outputs/2026_02_12__20_36_28___/export_3_0.dat)
