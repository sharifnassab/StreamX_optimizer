...
#SBATCH --mem=4096M
#SBATCH --array=1-4
#SBATCH --output=/home/asharif/scratch/StreamX_optimizer/outputs/2025_11_14__14_21_17__test0/3_0/output_%j.txt
...
$(sed -n "${SLURM_ARRAY_TASK_ID}p" < /home/asharif/scratch/StreamX_optimizer/outputs/2025_11_14__14_21_17__test0/export_3_0.dat)
