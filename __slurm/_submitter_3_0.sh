...
#SBATCH --mem=4096M
#SBATCH --array=1-1
#SBATCH --output=/home/asharif/scratch/StreamX_optimizer/outputs/2025_11_14__14_23_30__test0/3_0/output_%j.txt
...
$(sed -n "${SLURM_ARRAY_TASK_ID}p" < /home/asharif/scratch/StreamX_optimizer/outputs/2025_11_14__14_23_30__test0/export_3_0.dat)
