...
#SBATCH --mem=4096M
#SBATCH --array=1-10
#SBATCH --output=/home/asharif/scratch/StreamX_optimizer/outputs/2025_11_15__12_15_03__test0/8_0/output_%j.txt
...
$(sed -n "${SLURM_ARRAY_TASK_ID}p" < /home/asharif/scratch/StreamX_optimizer/outputs/2025_11_15__12_15_03__test0/export_8_0.dat)
