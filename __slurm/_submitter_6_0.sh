...
#SBATCH --mem=2048M
#SBATCH --array=1-6
#SBATCH --output=/home/asharif/scratch/StreamX_optimizer/outputs/2026_02_12__19_28_51__test0/6_0/output_%j.txt
...
$(sed -n "${SLURM_ARRAY_TASK_ID}p" < /home/asharif/scratch/StreamX_optimizer/outputs/2026_02_12__19_28_51__test0/export_6_0.dat)
